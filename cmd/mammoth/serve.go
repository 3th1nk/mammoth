...
func serve(args []string) error {
	...
	deps := api.Deps{
		...
		WindowsInstallShare:  cfg.WindowsInstallShare != "",
	...
	if cfg.Mode.RunsRunner() {
		exec := &provision.Executor{
			...
			WindowsInstallShare:         cfg.WindowsInstallShare,
			WindowsInstallShareUser:     cfg.WindowsInstallShareUser,
			WindowsInstallSharePassword: cfg.WindowsInstallSharePassword,
