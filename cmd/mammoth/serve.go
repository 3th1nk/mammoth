...
func serve(args []string) error {
	...
	deps := api.Deps{
		...
		WindowsInstallSMBShare: cfg.WindowsInstallSMBShare != "",
	...
	if cfg.Mode.RunsRunner() {
		exec := &provision.Executor{
			...
			WindowsInstallSMBShare:         cfg.WindowsInstallSMBShare,
			WindowsInstallSMBShareUser:     cfg.WindowsInstallSMBShareUser,
			WindowsInstallSMBSharePassword: cfg.WindowsInstallSMBSharePassword,
